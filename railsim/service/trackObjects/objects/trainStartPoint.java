 ...
 * @author js
 */
public class trainStartPoint extends trainStartObject {

	static Color col_hgr = new Color(0x00, 0xff, 0x00);
	...
	private void paintSig(Graphics2D g2, int x) {
		...
		p.addPoint(x, 0);
		p.addPoint(x + fscale - fscale / 2, fscale);
	...
	public trackObject clone() {
		trainStartPoint t = new trainStartPoint();
		t.setData(getData());
		return t;
	}

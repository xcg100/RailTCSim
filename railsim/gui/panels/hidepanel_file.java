 ...
 * @author js
 */
public class hidepanel_file extends javax.swing.JPanel {

	/**
	 * Creates new form hidepanel_file
	 */
	public hidepanel_file() {
		initComponents();
		...
		dataCollector.collector.filenameListeners.addListener(new AbstractListener() {
			...
			public void action(AbstractEvent e) {
				...
				reload_Button.setEnabled(dataCollector.collector.getFilename().length() > 0);
			}
		});
	}
    ...
    private void initComponents()
    {
        ...
        filename_TextField.setEditable(false);
        ...
        reload_Button.setMargin(new java.awt.Insets(2, 5, 2, 5));
        add(reload_Button);

        dotd_Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/railsim/gui/resources/totd.png")));
        dotd_Button.setText("Tip of Today...");
        dotd_Button.setMargin(new java.awt.Insets(2, 5, 2, 5));
